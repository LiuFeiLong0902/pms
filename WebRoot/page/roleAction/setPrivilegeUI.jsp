...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="images/title_arrow.gif"/> 配置权限
        </div>
...
<div id=MainArea>
	...
	<s:form action="roleAction_setPrivilege">
		<s:hidden name="role.id" value="<s:property value='#role.id' />"></s:hidden>
	 -->
	<form action="roleAction_setPrivilege">
        ...
        <div class="ItemBlock_Title1"><!-- 信息说明 -->
        	<div class="ItemBlock_Title1">
        		<img border="0" width="4" height="7" src="images/item_point.gif" /> 
        			正在为【<s:property value="#role.name" />】配置权限
        	</div> 
        </div>
